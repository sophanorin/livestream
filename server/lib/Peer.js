...
const { releasePort } = require("./helpers/ports");
...
class Peer extends EventEmitter {
    constructor({ id, roomId, socket }) {
        ...
        this._joinedBreakoutRoom = false;

        this._breakoutRoomId = null;
    ...
    close() {
        ...
        for (const port of this._remotePorts) {
            releasePort(port);
        }
    ...
    set breakoutRoomId(value) {
        return (this._breakoutRoomId = value);
    }

    get joinedBreakoutRoom() {
        return this._joinedBreakoutRoom;
    }

    set joinedBreakoutRoom(value) {
        return (this._joinedBreakoutRoom = value);
    }
