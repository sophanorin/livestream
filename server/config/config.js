...
module.exports = {
    ...
    auth: {
        ...
        oidc: {
            ...
            clientOptions: {
                client_id:
                    "161637528622-l64joaor41e5e7p6ttiirsie5l0t8nus.apps.googleusercontent.com",
                client_secret: "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",
    ...
    turnAPIKey: "openrelayprojectsecret",
    turnAPIURI: "turn:openrelay.metered.ca:80",
    turnAPIparams: {
        uri_schema: "turn",
        transport: "tcp",
        ip_ver: "ipv4",
    ...
    accessFromRoles: {
        ...
        [BYPASS_ROOM_LOCK]: [userRoles.ADMIN, userRoles.MODERATOR, userRoles.AUTHENTICATED],
    ...
    permissionsFromRoles: {
        ...
        [PARTICIPANT_CONTROL]: [userRoles.MODERATOR],
        // The role(s) have permission to lock/unlock a room
        [CHANGE_ROOM_LOCK]: [userRoles.MODERATOR, userRoles.AUTHENTICATED],
        // The role(s) have permission to promote a peer from the lobby
        [PROMOTE_PEER]: [userRoles.MODERATOR, userRoles.AUTHENTICATED],
    ...
    // Mediasoup settings
    mediasoup: {
        numWorkers: Object.keys(os.cpus()).length - 6,
