const initialState = {
    ...
    isSpeaking            : false,
    isAutoMuted           : true,
    localWebcamInProgress : false,
    localAudioInProgress  : false,
};
...
const me = (state = initialState, action) => {
    ...
    case "SET_MEDIA_CAPABILITIES": {
        const { canSendMic, canSendWebcam, canShareScreen, canShareFiles } =
                action.payload;
    ...
    case "SET_LOCAL_WEBCAM_IN_PROGRESS": {
        const { flag } = action.payload;

        return { ...state, localWebcamInProgress: flag };
    }

    case "SET_LOCAL_AUDIO_IN_PROGRESS": {
        const { flag } = action.payload;

        return { ...state, localAudioInProgress: flag };
    }
