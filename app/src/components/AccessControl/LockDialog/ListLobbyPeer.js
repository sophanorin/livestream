...
import { AdmitIcon } from "../../../assets/icons";
...
const ListLobbyPeer = (props) => {
    const { roomClient, peer, promotionInProgress, canPromote, classes } =
        props;
    ...
    return (
        <ListItem className={classnames(classes.root)} key={peer.peerId} button>
            <ListItemAvatar>
