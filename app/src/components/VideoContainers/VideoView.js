...
const styles = (theme) => ({
    ...
    displayNameEdit : {
        ...
        backgroundColor                : "rgba(85, 90, 99, 0.4)",
        borderRadius                   : 10,
        padding                        : theme.spacing(1),
        [theme.breakpoints.down("sm")] : {
