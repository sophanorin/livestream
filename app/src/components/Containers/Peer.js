...
import { RaiseHandIcon, MicOffIcon, MicOnIcon } from "../../assets/icons";
    ...
    useEffect(() => {
        const handler = setTimeout(() => {
            ...
            if (windowConsumer === consumer.id) {
                ...
                enableLayersSwitch &&
                consumer?.type !== "simple" &&
                fullScreenConsumer !== consumer.id
            ) {
                roomClient.adaptConsumerPreferredLayers(
                    consumer,
                    width,
                    height
                );
                ...
                <div className={classnames(classes.viewContainer)}>
                            ...
                            >
                                <div>
                                    <Fab
                                        ...
                                        onClick={() => {
                                            isSelected
                                                ? roomClient.removeSelectedPeer(
                                                    peer.id
                                                )
                                                : mode === "filmstrip"
                                                    ? roomClient.setSelectedPeer(
                                                        peer.id
                                                    )
                                                    : roomClient.addSelectedPeer(
                                                        peer.id
                                                    );
                                        }}
                                    >
                    ...
                    <VideoView
                        ...
                        consumerTemporalLayers={
                            webcamConsumer
                                ? webcamConsumer.temporalLayers
                                : null
                        }
                        consumerCurrentSpatialLayer={
                            webcamConsumer
                                ? webcamConsumer.currentSpatialLayer
                                : null
                        }
                        consumerCurrentTemporalLayer={
                            webcamConsumer
                                ? webcamConsumer.currentTemporalLayer
                                : null
                        }
                        ...
                        consumerPreferredTemporalLayer={
                            webcamConsumer
                                ? webcamConsumer.preferredTemporalLayer
                                : null
                        }
                        videoMultiLayer={
                        ...
                        videoScore={
                            webcamConsumer ? webcamConsumer.score : null
                        }
                        width={width}
                        height={height}
                ...
                >
                    <div className={classnames(classes.viewContainer)}>
                        ...
                        <VideoView
                            ...
                            consumerSpatialLayers={
                                screenConsumer
                                    ? screenConsumer.spatialLayers
                                    : null
                            }
                            consumerTemporalLayers={
                                screenConsumer
                                    ? screenConsumer.temporalLayers
                                    : null
                            }
                            consumerCurrentSpatialLayer={
                                screenConsumer
                                    ? screenConsumer.currentSpatialLayer
                                    : null
                            }
                            consumerCurrentTemporalLayer={
                                screenConsumer
                                    ? screenConsumer.currentTemporalLayer
                                    : null
                            }
                            consumerPreferredSpatialLayer={
                                screenConsumer
                                    ? screenConsumer.preferredSpatialLayer
                                    : null
                            }
                            consumerPreferredTemporalLayer={
                                screenConsumer
                                    ? screenConsumer.preferredTemporalLayer
                                    : null
                            }
                            videoMultiLayer={
                                screenConsumer &&
                                screenConsumer.type !== "simple"
                            }
                            videoTrack={screenConsumer && screenConsumer.track}
                            videoVisible={screenVisible}
                            videoCodec={screenConsumer && screenConsumer.codec}
                            videoScore={
                                screenConsumer ? screenConsumer.score : null
                            }
                            width={width}
                            height={height}
                        />
